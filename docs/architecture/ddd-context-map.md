...
| NFT          | `nft-service`          | Metadados NFT, mint futuro, ownership e integracao Polygon.          | NftMetadata, MintRequest, MarketplaceListing, Trade | `NftMetadataGenerated`, `NFTTransferred`, `MarketplaceListingCreated`, `TradeCreated`, `TradeAccepted`, `TradeCancelled` |
| Social       | `social-service`       | Amigos, convites, guildas, chat futuro e replay social.              | Friendship, Invite, Guild                           | `FriendInviteSent`, `FriendInviteAccepted`, `FriendInviteRejected`                                                       |
